                  ...
                  (order) => (
                    ...
                    >
                      <div className="flex items-start justify-between gap-3">
                        ...
                        <span
                          className={`shrink-0 whitespace-nowrap rounded-full px-3 py-1 text-xs font-semibold ${statusStyle(
                            order.status
                          )}`}
                        >
                          {formatStatus(
                  ...
                  <table className="w-full table-auto">
                    <thead>
                      <tr className="bg-slate-50">
                        <th className="px-4 py-4 text-left text-xs font-semibold uppercase text-slate-500 lg:px-5 xl:px-6">
                          Order
                        </th>
                        ...
                        <th className="px-4 py-4 text-right text-xs font-semibold uppercase text-slate-500 lg:px-5 xl:px-6">
                          Action
                        </th>
                      </tr>
                    </thead>
                    ...
                    <tbody className="divide-y divide-slate-100">
                      {recentOrders.map(
                        (order) => (
                          ...
                          >
                            <td className="px-4 py-4 align-middle lg:px-5 xl:px-6">
                            ...
                            <td className="w-full px-4 py-4 align-middle lg:px-5 xl:px-6">
                              <div className="min-w-0">
                            ...
                            <td className="px-4 py-4 align-middle lg:px-5 xl:px-6">
                              <span
                                className={`inline-flex whitespace-nowrap rounded-full px-3 py-1 text-xs font-semibold ${statusStyle(
                                  order.status
                                )}`}
                              >
                                {formatStatus(
                            ...
                            <td className="px-4 py-4 text-right align-middle lg:px-5 xl:px-6">
                              <button
                                type="button"
                                onClick={() =>
                                  navigate(
                                ...
                                className="whitespace-nowrap rounded-lg bg-blue-50 px-3 py-2 text-xs font-semibold text-blue-600 transition hover:bg-blue-100"
                              >
                                View Order
                              </button>
                            </td>
