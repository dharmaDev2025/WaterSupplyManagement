  ...
  return (
    <div className="min-h-screen w-full bg-gray-50 lg:flex lg:items-start">
      ...
      <aside
        ...
        } lg:sticky lg:top-0 lg:z-30 lg:h-screen lg:w-[270px] lg:shrink-0 lg:translate-x-0`}
      >
      ...
      <div className="min-h-screen min-w-0 flex-1 bg-gray-50">
        ...
        <main className="min-h-[calc(100vh-80px)] w-full min-w-0 overflow-x-hidden px-4 py-6 sm:px-6 sm:py-7 lg:px-6 lg:py-8 xl:px-8">
